...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "ecommerce.authentication.CookiesJWTAuthentication", 
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": True,  # make a new refresh token every time the user use it, to make infinite login
